...
int main()
{
	...
	while (true)
	{
		system("cls");
		cout << endl << endl;
		cout << "\t\tquyen dep gai khong ? ";
		getline(cin, ngiu);
		if (ngiu == "CO")
		{
			cout << "\t\t---CHINH XAC QUYEN SIEU DEP GAI !---" << endl << endl;
			cout << "\t\tSIEU DEP GAI..." << endl;
			Sleep(1000);
			cout << "\t\tSIEU DEP GAI..." << endl; Sleep(1000);
			cout << "\t\tSIEU DEP GAI..." << endl; Sleep(1000);
			cout << "\t\tSIEU DEP GAI..." << endl; Sleep(1000);
			cout << "\t\tSIEU DEP GAI..." << endl; Sleep(1000);
			cout << "\t\tSIEU DEP GAI..." << endl; Sleep(1000);
			...
			while (true)
			{
				...
				ifstream file;
				file.open("C:\\Users\\ACER\\Downloads\\banner.txt", ios_base::in); //import file thì copy du?ng d?n r?i d?i \ thành \\ ho?c /
				string line;
